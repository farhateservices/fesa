...
document.querySelector('.back-to-top').addEventListener('click', function() {
  ...
  // Automate WhatsApp message when "Contact WhatsApp" buttons are clicked
  const contactButtons = document.querySelectorAll('.contact-wp');
  const phoneNumber = '+919830836212';
  const message = `Hello Farhat e Services & Assistance!`;
